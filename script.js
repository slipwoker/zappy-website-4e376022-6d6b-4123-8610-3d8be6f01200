        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '4e376022-6d6b-4123-8610-3d8be6f01200',
                name: formData.name,
                email: formData.email,
                subject: 'Contact Form Submission - גן אנגלית',
                message: `שם: ${formData.name}\nאימייל: ${formData.email}\nטלפון: ${formData.phone}\nגיל הילד: ${formData.childAge}\n\nהודעה:\n${formData.message}`,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "גן אנגלית משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
